...
const products: IProduct[] = [
  ...
  },
  {
    ...
    image: '/wp-content/uploads/2024/12/yes-no-question-e1734361555519.webp',
  ...
  {
    id: '420',
    title: 'Расширенный годовой расклад Таро',
    link: '/product/expanded-year-tarot-consultation',
    image: '/wp-content/uploads/2024/12/expanded-tarot-consultation-e1734863593518.webp',
    text: 'Годовой расклад на 12 сфер жизни: личность человека; финансы; окружение и друзья; родительский дом; хобби, удовольствия, дети; здоровье; семья, отношения, партнёрство; трудности которые ждут человека; карта путешествия, дорог; профессия, карьера, работа; карта удачи или упущенных возможностей; скрытые вопросы, магические воздействия. Каждая из этих сфер рассматривается на целый следующий год. Очень сильная карта, способная помочь узнать слабые места в грядущем году и проработать их. Расклад возможен только ДВАЖДЫ в год - в канун солярного нового года (31 декабря) и в день рождения человека',
    time: '3 часа',
    type: ProductType.TarotConsultation,
    price: 20000,
  },
